                           ...
                           unsigned int keybits)
{
    ...
    default: return(-1);//invalid key length
    }

    rk = RK = buf;

    //code with _mm_aeskeygenassist_si128 can be added for optimization.
                           ...
                           unsigned int keybits)
{
    ...
    rk2 = buf2;
    /* Also checks keybits */
    if ((ret = mbedtls_aes_setkey_enc(nr, rk2, buf2, key, keybits)) != 0)
        goto exit;
