...
#define TEST_VECTOR_COUNT 3//currently 3 encrypt test vectors added.
#define VERIFY_GCM_TEST_VECTOR_NUM 0 //set 0 or 1 or 2, to verify the test vector
...
static int test_pt_len[TEST_VECTOR_COUNT] = {32, 0, 16};
static int test_ad_len[TEST_VECTOR_COUNT] = {0, 16, 48};
static int test_tag_len[TEST_VECTOR_COUNT] = {14, 15, 4};

static uint8_t test_key[TEST_VECTOR_COUNT][16] = {{0xc7, 0x51, 0x16, 0xc1, 0x9f, 0x5e, 0xa4, 0xed, 0x1b, 0x10, 0xbf, 0x0e, 0xaa, 0xeb, 0xe5, 0xa1 },
...
static uint8_t test_iv[TEST_VECTOR_COUNT][12]  = {{ 0x48, 0xa5, 0x3f, 0xc1, 0x7d, 0x43, 0x00, 0xf4, 0xa2, 0x3a, 0x5a, 0x39 },
                                                    {0xd3 ,0x9d ,0x4b ,0x4d ,0x3c ,0xc9 ,0x27 ,0x88 ,0x50 ,0x90 ,0xe6 ,0xc3 },
                                                    {0x43 ,0x7b ,0x73 ,0xe6 ,0x24 ,0x90 ,0x66 ,0x52 ,0x95 ,0x6b ,0xd2 ,0xfb}};

static uint8_t test_pt[TEST_VECTOR_COUNT][32]  = {{ 0x45, 0x69, 0x94, 0x4f, 0xcd, 0xe5, 0xb3,
...
static uint8_t test_ad[TEST_VECTOR_COUNT][48] = {{0xe7 ,0xe5 ,0xe6 ,0xf8 ,0xda ,0xc9 ,0x13 ,0x03 ,0x6c ,0xb2 ,0xff ,0x29 ,0xe8 ,0x62 ,0x5e ,0x0e },
                                                ...
                                                { 0x41 ,0xe3 ,0x28 ,0x80 ,0x8d ,0x08 ,0x1b ,0x67 ,0x7d ,0x8f ,0x51 ,0xbd ,0xae ,0xdf ,0x0a ,0xa7
                                                 ,0xb4 ,0x2e ,0x4d ,0xe8 ,0x8c ,0x1a ,0x90 ,0x04 ,0x19 ,0x6d ,0x7c ,0xa5 ,0xe0 ,0xe4 ,0xf9 ,0xaa ,0xb3
                                                  ,0xa7 ,0x8f ,0x26 ,0xcf ,0x01 ,0xd6 ,0x0d ,0xee ,0xc6 ,0x2d ,0xad ,0x8f ,0x9f ,0xd6 ,0x2b}};
