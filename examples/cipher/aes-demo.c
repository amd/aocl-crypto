...
#define TEST_VECTOR_COUNT          7 //currently 7 encrypt test vectors added.
#define VERIFY_GCM_TEST_VECTOR_NUM 6 //set test id 0 or 1 or 2 or 3 or 4 or 5 or 6
...
static int test_ad_len[TEST_VECTOR_COUNT]  = { 0, 16, 48, 16, 20, 20, 16};
static int test_tag_len[TEST_VECTOR_COUNT] = {14, 15, 4,  13, 16, 8 , 15};
static int test_pt_len[TEST_VECTOR_COUNT]  = {32,  0, 16, 13, 51, 16, 16};
static int test_iv_len[TEST_VECTOR_COUNT]  = {12,  12, 12, 12, 12, 1, 128};
