...
static int test_ad_len[TEST_VECTOR_COUNT]  = { 0, 16, 48, 16, 20};
static int test_tag_len[TEST_VECTOR_COUNT] = {14, 15, 4,  13, 16};
static int test_pt_len[TEST_VECTOR_COUNT]  = {32,  0, 16, 13, 51};
