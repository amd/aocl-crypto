...
char * bytesToHexString(unsigned char *, int);
...
int main(int argc, char const *argv[])
{
    ...
    alc_context_t ctx;
    {
        ...
        rng_info.r_distrib = ALC_RNG_DISTRIB_UNIFORM;   // Output should be uniform probablilty
...
char * bytesToHexString(unsigned char * bytes, int length){
